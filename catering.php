...
<!--                                        <div class="overlay"></div>-->
                        ...
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-5 catering-text" data-paroller-factor="-0.1" data-paroller-type="foreground" data-paroller-direction="horizontal">
                            ...
                            <p>Мы с радостью предоставим нашу кондитерскую в теплый период года, например, чтобы провести день рождения или школьный утренник или мы приедем и накроем стол, куда захотите.   </p>
                        </div>
                    </div>
                </div>
            </div>
