        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-6 footer-menu secondM">
                    ...
                    ?>
                    <img class="img_logo" src="<?= get_template_directory_uri() ?>/assets/img/uslogo.png">
                </div>
            </div>
...
<script src="<?= get_template_directory_uri() ?>/assets/js/jQuery3.2.1.min.js"></script>
        <script src="<?= get_template_directory_uri() ?>/assets/bootstrap/js/tether.min.js"></script>
        <script src="<?= get_template_directory_uri() ?>/assets/bootstrap/js/bootstrap.min.js"></script>
<script async src="<?= get_template_directory_uri();?>/assets/paroller/dist/jquery.paroller.min.js"></script>
<script async src="<?= get_template_directory_uri();?>/assets/js/custom.js"></script>
<script async src="<?= get_template_directory_uri();?>/assets/js/card_helper.js"></script>
</body>
</html>