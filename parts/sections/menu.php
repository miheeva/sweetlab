...
<div class="wrapper section-menu" data-paroller-factor="0.5" data-paroller-type="foreground" data-paroller-direction="vertical">
    <div class="after" data-paroller-factor="-0.15" data-paroller-type="foreground" data-paroller-direction="vertical" style="background-image: url('<?php echo the_post_thumbnail_url($menuPage)?>')"></div>
    <div class="container">
