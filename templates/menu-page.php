        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 dropdown">
                <ul class="menu-link nav nav-tabs hidden-mobile" role="tablist" aria-labelledby="dropdownMenuButton">
                    ...
                    <li>
                        <a class="nav-link dropdown-item" data-toggle="tab" href="#capkey" role="tab">Капкейки</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="menu-item slider">
                                <div id="m1<?=$loop->post->ID;?>" class="carousel slide" data-ride="carousel" data-interval="false">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active" style="background-image: url('<?php has_post_thumbnail() ? the_post_thumbnail_url($loop->post->ID) : print get_template_directory_uri()."/assets/img/nophoto.jpg"?>')">
...
// Параметры отображения выведенных товаров
                ...
                <div class="tab-pane" id="capkey" role="tabpanel">
                    <div class="row">
                        <?php
                        $args = array(
                            'tax_query' => array(
